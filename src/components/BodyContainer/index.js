        ...
        <ul className="products">
          <li className="row">
            <div className="col left">
              <div className="thumbnail">
                <a href="https://via.placeholder.com/200x150">
                  <img src="https://via.placeholder.com/200x150" alt="" />
                </a>
              </div>
              <div className="detail">
                <div className="name"><a href="https://via.placeholder.com/200x150">PRODUCT ITEM NUMBER 1</a></div>
          ...
          <li className="row">
            <div className="col left">
              ...
              <div className="detail">
                <div className="name"><a href="https://via.placeholder.com/200x150">PRODUCT ITEM NUMBER 2</a></div>
                <div className="description">
